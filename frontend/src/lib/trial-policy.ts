...
export const TRIAL_MODE_OPTIONS: { value: TrialMode; label: string; hint: string }[] = [
  {
    value: 'OFF',
    label: 'Desligado',
    hint: 'Novos alunos entram direto como Ativo.',
  },
  {
    value: 'DAYS',
    label: 'Por dias',
    hint: 'Período experimental com data de término automática.',
  },
  {
    value: 'FREE_CLASS',
    label: 'Aula grátis',
    hint: 'Aluno entra como Experimental até conversão manual.',
  },
  {
    value: 'MANUAL',
    label: 'Manual',
    hint: 'Quem cadastra escolhe Ativo ou Experimental.',
  },
]
